    ...
    render() {
        ...
        const opt = {
            ...
            callback: (index) => {
                ...
                this.SwipeCategory = this.SwipeCategory.bind(this)
            }
        ...
        return (
            <div id="home-category">
                ...
                <div className="index-container">
                    <ul>
                        <li className={this.state.index === 0 ? "selected" : ''} data-index="0" onClick={this.SwipeCategory}></li>
                        <li className={this.state.index === 1 ? "selected" : ''} data-index="1" onClick={this.SwipeCategory}></li>
                        <li className={this.state.index === 2 ? "selected" : ''} data-index="2" onClick={this.SwipeCategory}></li>
                    </ul>
                </div>
            </div>
        )
